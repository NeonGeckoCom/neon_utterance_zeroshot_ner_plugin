...
PLUGIN_ENTRY_POINT = 'neon_utterance_zeroshot_ner_plugin=neon_utterance_zeroshot_ner_plugin:TarsZeroShotNER'
setup(
    name='neon_utterance_zeroshot_ner_plugin',
    version='0.0.1',
    ...
    license='bsd3',
    packages=['neon_utterance_zeroshot_ner_plugin'],
    zip_safe=True,
